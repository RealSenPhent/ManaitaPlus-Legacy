package sen.manaita_plus_legacy.common.menu.slot;
...
public class ManaitaPlusLegacyFurnaceFuelSlot  extends Slot {
    private final ManaitaPlusLegacyFurnaceMenu menu;

    public ManaitaPlusLegacyFurnaceFuelSlot(ManaitaPlusLegacyFurnaceMenu p_39520_, Container p_39521_, int p_39522_, int p_39523_, int p_39524_) {

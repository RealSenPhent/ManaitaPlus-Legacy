...
public class ManaitaPlusCraftingPortabl extends Item {
    public ManaitaPlusCraftingPortabl() {
        super(new Properties().defaultDurability(-1).fireResistant().stacksTo(1));
    }

    @Override
    public Component getName(ItemStack p_41458_) {
        return Component.translatable("item.portableCrafting."+ p_41458_.getOrCreateTag().getInt("ManaitaType") +".name");
    }
        ...
        if (p_41433_ instanceof ServerPlayer serverPlayer)
            NetworkHooks.openScreen(serverPlayer, new MenuProvider() {
                ...
                public AbstractContainerMenu createMenu(int p_39954_, Inventory p_39955_, Player p_39956_) {
                    return new ManaitaPlusCraftingMenu(p_39954_, p_39955_, p_39956_.level());
                }
            });

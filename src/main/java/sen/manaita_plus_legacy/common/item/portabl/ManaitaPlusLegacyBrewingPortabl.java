...
public class ManaitaPlusLegacyBrewingPortabl extends Item {
    public ManaitaPlusLegacyBrewingPortabl() {
    ...
    public class ManaitaPlusBrewingStandBlockEntity extends BaseContainerBlockEntity  {
        ...
        public ManaitaPlusBrewingStandBlockEntity(Player player, ItemStack stack) {
            super(ManaitaPlusLegacyBlockEntityCore.BREWING_BLOCK_ENTITY.get(), player.blockPosition(),null);
            this.player = player;
            this.stack = stack;

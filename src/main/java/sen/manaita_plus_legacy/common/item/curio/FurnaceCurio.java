        ...
        if (p_41433_ instanceof ServerPlayer serverPlayer) {
            ...
            NetworkHooks.openScreen(serverPlayer, new MenuProvider() {
                ...
                public AbstractContainerMenu createMenu(int p_39954_, Inventory p_39955_, Player p_39956_) {
                    ManaitaPlusLegacyFurnacePortabl.ManaitaPlusFurnaceBlockEntity block = new ManaitaPlusLegacyFurnacePortabl.ManaitaPlusFurnaceBlockEntity(p_39956_,itemInHand);

...
public class ManaitaPlusLegacyNBTCraftingRecipe implements CraftingRecipe, net.minecraftforge.common.crafting.IShapedRecipe<CraftingContainer> {
    ...
    public static class Serializer implements RecipeSerializer<ManaitaPlusLegacyNBTCraftingRecipe> {
        public ManaitaPlusLegacyNBTCraftingRecipe fromJson(ResourceLocation p_44236_, JsonObject p_44237_) {
        ...
        public ManaitaPlusLegacyNBTCraftingRecipe fromNetwork(ResourceLocation p_44239_, FriendlyByteBuf p_44240_) {

...
import sen.manaita_plus_legacy.common.entity.ManaitaPlusEntityArrow;

@OnlyIn(Dist.CLIENT)
public class RenderManaitaArrow extends ArrowRenderer<ManaitaPlusEntityArrow> {
    ...
    public ResourceLocation getTextureLocation(ManaitaPlusEntityArrow p_116140_) {

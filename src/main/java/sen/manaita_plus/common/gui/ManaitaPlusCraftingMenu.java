...
public class ManaitaPlusCraftingMenu extends RecipeBookMenu<CraftingContainer> {
    ...
    public ManaitaPlusCraftingMenu(int p_39356_, Inventory p_39357_, ContainerLevelAccess p_39358_) {
        super(ManaitaPlusMenuCore.CraftingManaita.get(), p_39356_);
        ...
        if (!p_150548_.isClientSide) {
            ...
            if (optional.isPresent()) {
                ...
                if (itemstack1.isItemEnabled(p_150548_.enabledFeatures())) {
                    ...
                    itemstack.setCount(itemstack.getCount() * 64);
                }
            }

package sen.manaita_plus.common.gui;
...
import sen.manaita_plus.common.core.ManaitaPlusMenuCore;

public class ManaitaPlusBrewingStandMenu extends AbstractContainerMenu {
    private final Container brewingStand;
    private final ContainerData brewingStandData;
    private final Slot ingredientSlot;

    public ManaitaPlusBrewingStandMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
        this(id, inv, new SimpleContainer(5), new SimpleContainerData(2));
    }

    public ManaitaPlusBrewingStandMenu(int p_39093_, Inventory p_39094_, Container p_39095_, ContainerData p_39096_) {
        super(ManaitaPlusMenuCore.BrewingStandManaita.get(), p_39093_);

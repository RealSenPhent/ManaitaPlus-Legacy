...
public class ManaitaPlusAxeItem extends DiggerItem implements IManaitaPlusKey, IManaitaPlusDestroy {
    ...
    public void onManaitaKeyPress(ItemStack itemStack, Player player) {
        ...
        ManaitaPlusUtils.chat(Component.literal(ManaitaPlusText.manaita_mode.formatting(String.format("[%s] %s: %s", I18n.get("item.manaita_plus.manaita_axe"),I18n.get("mode.doubling"), (getDoubling(itemStack) ? I18n.get("info.on") : I18n.get("info.off"))))));
    }

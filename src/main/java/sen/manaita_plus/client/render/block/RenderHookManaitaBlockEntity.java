...
@OnlyIn(Dist.CLIENT)
public class RenderHookManaitaBlockEntity implements BlockEntityRenderer<ManaitaPlusHookBlockEntity> {
    private final EntityRenderDispatcher entityRenderer;
    private final ItemStack stack;

    public RenderHookManaitaBlockEntity(BlockEntityRendererProvider.Context p_173673_) {
        this.entityRenderer = p_173673_.getEntityRenderer();
        stack = new ItemStack(ManaitaPlusBlockCore.HookBlockItem.get());
    }


    @Override
    public void render(ManaitaPlusHookBlockEntity blockEntity, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, int packedLight, int packedOverlay) {
        ...
        if (block instanceof ManaitaPlusHookBlock) {
    ...
    @Override
    public boolean shouldRenderOffScreen(ManaitaPlusHookBlockEntity p_112306_) {
    ...
    @Override
    public boolean shouldRender(ManaitaPlusHookBlockEntity p_173568_, Vec3 p_173569_) {
